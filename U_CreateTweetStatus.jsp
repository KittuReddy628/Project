...
<%@ page import="java.util.Date" %>
			...
			%>
				...
				{		
						...
						String query1="select * from ttopic  where tname='"+tname+"' and user='"+user+"' "; 
					...
					if ( rs1.next() )
					   {
							...
							String purpose="Tried to Create Same Tweet Again";
						    String ustatus="Fake User";
							
						PreparedStatement ps=connection.prepareStatement("insert into fakeuser(username,tname,purpose,dt,uurl) values(?,?,?,?,?)");
						ps.setString(1,user);
						...
						String query11="update user set user_kind='"+ustatus+"'  where username='"+user+"' "; 
						...
						%>
							...
							<p>&nbsp;</p>
							<p align="center" class="style24 style25 style43">Tweet Name Already Exists..U r Considered As Fake User </p>
							<p align="center" class="style18 style24">&nbsp;</p>
			  <p align="center" class="style21"><a href="U_CreateTweet.jsp"><strong>Back</strong></a></p>
							<p align="center">
							<%
					   ...
					   else
					   {
						...
						PreparedStatement ps1=connection.prepareStatement("insert into tweet_url(username,tweet_name,URL,dt) values(?,?,?,?)");
						ps1.setString(1,user);
						ps1.setString(2,tname);
						ps1.setString(3,aurl);	
						ps1.setString(4,dt);
