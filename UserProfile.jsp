    	...
    	<div class="content_box">
            ...
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
              <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
                ...
                <tr>
                  <td  width="145" height="40" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style26 style43" style="margin-left:20px;"><strong>E-Mail</strong></div></td>
                ...
                <tr>
                  <td  width="145" height="40" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style26 style43" style="margin-left:20px;"><strong>Mobile</strong></div></td>
                  <td  width="164" valign="middle" height="40"><div align="left" class="style40 style10" style="margin-left:20px;"><strong>
                      <%out.println(s2);%>
                  </strong></div></td>
                </tr>
                <tr>
                  <td  width="145" height="40" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style26 style43" style="margin-left:20px;"><strong>Address</strong></div></td>
                  <td  width="164" align="left" valign="middle" height="40"><div align="left" class="style40 style10" style="margin-left:20px;"><strong>
                      <%out.println(s3);%>
                  </strong></div></td>
                </tr>
                <tr>
                  <td  width="145" height="40" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style26 style43" style="margin-left:20px;"><strong>Date of Birth</strong></div></td>
                  <td  width="164" align="left" valign="middle" height="40"><div align="left" class="style40 style10" style="margin-left:20px;"><strong>
                      <%out.println(s5);%>
                  </strong></div></td>
                </tr>
                <tr>
                  <td   width="145" height="51" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style43 style26" style="margin-left:20px;"><strong>Status</strong></div                        ></td>
                ...
                <tr>
                  <td   width="145" height="51" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style43 style26" style="margin-left:20px;"><strong>Account Status</strong></div                        ></td>
                  <td  width="164" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style44">
                      <div align="left" class="style10" style="margin-left:20px;"><strong>
                        <%out.println(s5);%>
                      </strong></div>
                  </div></td>
                </tr>
