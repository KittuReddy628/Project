    	...
    	<div class="content_box">
            ...
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
              <table width="933" border="2" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; margin:10px 0px 0px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
                <tr>
                  <td  width="157" height="30" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">Username</div></td>
                  <td  width="165" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">E-mail</div></td>
                  <td  width="134" height="30" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">Mobile</div></td>
                  <td  width="216" height="30" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">Address</div></td>
                  <td  width="109" height="30" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">Gender</div></td>
                  <td  width="111" height="30" align="center" valign="bottom" bgcolor="#FF00FF" style="color: #2c83b0;"><div align="center" class="style9 style53">Status</div></td>
                </tr>
