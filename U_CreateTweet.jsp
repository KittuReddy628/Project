    	...
    	<div class="content_box">
            ...
            <form action="U_CreateTweetStatus.jsp" method="post" enctype="multipart/form-data" name="form1">
              <table width="450" height="354" align="center"  cellpadding="0" cellspacing="0"  >
                <tr>
                  <td height="40" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><span class="style43">Tweet Name </span></td>
                  <td valign="middle" height="40" style="color:#000000;"><label>
                    <input name="tname" type="text" size="39" />
                  </label></td>
                </tr>
                <tr>
                  <td  width="191" height="118" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><span class="style43">Tweet Description </span></td>
                  <td  width="257" valign="middle" height="118"><label>
                    <textarea name="des" cols="40" rows="6"></textarea>
                  </label></td>
                </tr>
                <tr>
                  <td  width="191" height="40" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><span class="style43">Tweet Uses </span></td>
                  <td  width="257" align="left" valign="middle" height="40"><textarea name="uses" cols="40" rows="4"></textarea></td>
                </tr>
                <tr>
                  <td height="54" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><span class="style43">Select Tweet Image </span></td>
                ...
                <tr>
                  ...
                  <td  width="257" align="left" valign="middle" height="70"><label>
                    <div align="center">
                      <input type="submit" name="Submit" value="Create Tweet    " style="height:35px; color:#000000; background-color:#00FF33"  />
                    </div>
                  </label></td>
                </tr>
              </table>
